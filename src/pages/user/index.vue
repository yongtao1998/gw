...
<script>
  export default {
    ...
    // 小程序 监听 右上角 转发分享 执行的函数
    onShareAppMessage(){
        console.log('转发分享哦')
        // 转发 标题 微信取的  转发图片 是页面截图
        //  我们可以自己定义 转发的 内容
        return {
          title:"震惊！小草居然这样帅！！", //微信看到的  转发标题
          path:"/pages/index/index", // 别人打开 转发的 会进入小程序这个页面
          imageUrl:"https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3293144012,2335984271&fm=26&gp=0.jpg" // 转发的图片路径
        }
    }
  }
</script>
